...
chat = AzureChatOpenAI(
    azure_endpoint=st.secrets.OpenAIAPI.OPENAI_API_ENDPOINT,
    openai_api_version=st.secrets.OpenAIAPI.OPENAI_API_VER,
    deployment_name=st.secrets.OpenAIAPI.OPENAI_API_DEPLOY_NAME,
    openai_api_key=st.secrets.OpenAIAPI.OPENAI_API_KEY,
    openai_api_type=st.secrets.OpenAIAPI.OPENAI_API_TYPE,
)
